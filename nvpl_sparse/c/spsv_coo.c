...
int main(void) {
    ...
    const int A_nnz           = 9;
    int       A_coo_rows[]   = { 0, 0, 0, 1, 2, 2, 2, 3, 3 };
    int       A_coo_cols[]   = { 0, 2, 3, 1, 0, 2, 3, 1, 3 };
    ...
    CHECK_SPARSE( nvpl_sparse_create_coo(&matA, A_num_rows, A_num_cols, A_nnz,
                                      A_coo_rows, A_coo_cols, A_values,
    ...
    if (correct)
        printf("c_spsv_coo test PASSED\n");
    else
        printf("c_spsv_coo test FAILED: wrong result\n");
