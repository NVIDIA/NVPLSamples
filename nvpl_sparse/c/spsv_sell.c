 ...
 */
 ...
 int main(void) {
    ...
    int     A_sliceOffsets[] = { 0, 6, 12 };
    int     A_columns[]      = { //Slice 0
                                   0, 1,
                                   2, -1,
                                   3, -1,
                                   //Slice 1
    ...
    CHECK_SPARSE( nvpl_sparse_create_sliced_ell(&matA, A_num_rows, A_num_cols, A_nnz,
                                        A_values_size, A_slice_size,
                                        A_sliceOffsets, A_columns, A_values,
    ...
    if (correct)
        printf("c_spsv_sell test PASSED\n");
    else
        printf("c_spsv_sell test FAILED: wrong result\n");
