...
*
*      Call CTBSV subroutine
      call CTBSV(uplo,transa,diag,n,k,a,lda,x,incx)
*
      print*
      print 102, 'After CTBSV operation:'
      call print_cvector(x,n,incx,'X')

      stop
 99   format('Example: CTBSV for solving the triangular banded linear '
