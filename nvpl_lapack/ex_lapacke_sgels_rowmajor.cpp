...
int main() {
    ...
    //     4   2   5
    //     5   4   3
    float A[lda * m] = {1, 1, 1, 2, 3, 4, 3, 5, 2, 4, 2, 5, 5, 4, 3};
    ...
    //      16  16
    //      18  16
    float b[ldb * m] = {-10, -3, 12, 14, 14, 12, 16, 16, 18, 16};

    printf("NVPL LAPACK version: %d\n", nvpl_lapack_get_version());

    // Print inputs.
    print_smatrix_rowmajor("Entry Matrix A", m, n, A, lda);
    print_smatrix_rowmajor("Right Hand Side b", m, nrhs, b, ldb);
    printf("\n");
