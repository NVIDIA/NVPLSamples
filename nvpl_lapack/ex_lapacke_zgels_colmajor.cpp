...
int main()
{
    ...
    //     4   2   5
    //     5   4   3
    nvpl_dcomplex_t A[lda * n] = {1, 2, 3, 4, 5, 1, 3, 5, 2, 4, 1, 4, 2, 5, 3};
    ...
    //      16  16
    //      18  16
    nvpl_dcomplex_t b[ldb * nrhs] = {-10, 12, 14, 16, 18, -3, 14, 12, 16, 16};
    ...
    printf("\n");
    printf("LAPACKE_zgels (col-major, high-level) Example Program Results\n");

    // Solve least square problem: min_x || A * x - b ||.
    char no_transpose = 'N';
    nvpl_int_t info = LAPACKE_zgels(LAPACK_COL_MAJOR, no_transpose, m, n, nrhs,
            A, lda, b, ldb);
