...
int main()
{
    ...
    //      47   11
    //     -16   54
    nvpl_scomplex_t b[ldb * n] = {-3, 17, 9, 55, 47, 11, -16, 54};
    ...
    char lower = 'L';
    nvpl_int_t info = LAPACKE_cposv(LAPACK_ROW_MAJOR, lower, n, nrhs, A, lda,
            b, ldb);
    ...
    print_cmatrix_rowmajor("Cholesky factor", n, n, A, lda);
    printf("\n");
