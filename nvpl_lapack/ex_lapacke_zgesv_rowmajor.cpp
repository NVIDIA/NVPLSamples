...
int main()
{
    ...
    //     -1   2   0   1
    //      3  -1   2   2
    nvpl_dcomplex_t A[lda * n] = {1, 2, 2, -3, 0, 1, 2, 1, -1, 2, 0, 1, 3, -1, 2, 2};
    ...
    //     -1    3
    //      9   10
    nvpl_dcomplex_t b[ldb * n] = {13, 1, 6, 7, -1, 3, 9, 10};
    ...
    // Print inputs.
    print_zmatrix_rowmajor("Entry Matrix A", n, n, A, lda);
    print_zmatrix_rowmajor("Right Hand Side b", n, nrhs, b, ldb);
    printf("\n");
    printf("LAPACKE_zgesv (row-major, high-level) Example Program Results\n");

    // Solve A * x = b.
    nvpl_int_t info = LAPACKE_zgesv(LAPACK_ROW_MAJOR, n, nrhs, A, lda, ipiv,
            b, ldb);
    ...
    // Print LU factors.
    print_zmatrix_rowmajor("LU factors", n, n, A, lda);
    printf("\n");
