...
int main()
{
    ...
    //      47   11
    //     -16   54
    nvpl_dcomplex_t b[ldb * n] = {-3, 17, 9, 55, 47, 11, -16, 54};
    ...
    printf("\n");
    printf("LAPACKE_zposv (row-major, high-level) Example Program Results\n");
    ...
    print_zmatrix_rowmajor("Cholesky factor", n, n, A, lda);
    printf("\n");
