...
int main() {
    ...
    // Workspace query.
    NVPL_LAPACK_dsyev(&jobz, &uplo, &n, A, &lda, w, &work_query, &lwork, &info);
    ...
    NVPL_LAPACK_dsyev(&jobz, &uplo, &n, A, &lda, w, work, &lwork, &info);
    ...
    // Print eigenvectors.
    print_dmatrix_colmajor("Eigenvectors", n, n, A, lda);
    printf("\n");
