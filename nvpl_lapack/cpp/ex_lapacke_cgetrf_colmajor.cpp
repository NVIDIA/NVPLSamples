...
int main() {
    ...
    printf("\n");
    printf("LAPACKE_cgetrf (col-major) Example Program Results\n");

    // Compute LU factorization P * A = L * U.
    nvpl_int_t info = LAPACKE_cgetrf(LAPACK_COL_MAJOR, m, n, A, lda, ipiv);
    ...
    // Print LU factors.
    print_cmatrix_colmajor("LU factors", m, n, A, lda);
    printf("\n");
