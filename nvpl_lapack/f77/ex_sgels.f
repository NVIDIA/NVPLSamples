program usageexample
    ...
    call print_smatrix(a, m, n, lda, 'Entry Matrix A')
    call print_smatrix(b, m, nrhs, ldb, 'Right Hand Side Matrix b')
    
    print *, "sgels Example Program Results"
    print *
    
    ! Workspace query
    lwork = -1
    call sgels(trans, m, n, nrhs, a, lda, b, ldb, work_query, lwork, info)
