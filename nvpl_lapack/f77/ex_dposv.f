program usageexample
    ...
    !    -3   0  15  -8
    !     7  17  -8  23
    a = reshape([4.0d0, 5.0d0, -3.0d0, 7.0d0, &
                 5.0d0, 16.0d0, 0.0d0, 17.0d0, &
                 -3.0d0, 0.0d0, 15.0d0, -8.0d0, &
                 7.0d0, 17.0d0, -8.0d0, 23.0d0], [lda, n])
    ...
    !     47  11
    !    -16  54
    b = reshape([-3.0d0, 9.0d0, 47.0d0, -16.0d0, &
                 17.0d0, 55.0d0, 11.0d0, 54.0d0], [ldb, nrhs])
    
    ! Print input matrices
    call print_dmatrix(a, n, n, lda, 'Entry Matrix A')
    call print_dmatrix(b, n, nrhs, ldb, 'Right Hand Side Matrix b')

    print *, "dposv Example Program Results"
    print *
    ...
    print *, "Solution x:"
    call print_dmatrix(b, n, nrhs, ldb, 'x')

    ! Print Cholesky factor (lower triangular part of A is overwritten with L factor)
    call print_dmatrix(a, n, n, lda, 'Cholesky factor L')
