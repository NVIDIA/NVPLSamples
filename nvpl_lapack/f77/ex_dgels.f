program usageexample
    ...
    !      16  16
    !      18  16
    b = reshape([-10.0d0, 12.0d0, &
                 14.0d0, 16.0d0, &
                 18.0d0, -3.0d0, &
                 14.0d0, 12.0d0, &
                 16.0d0, 16.0d0], [ldb, nrhs])
    
    ! Print input matrices
    call print_dmatrix(a, m, n, lda, 'Entry Matrix A')
    call print_dmatrix(b, m, nrhs, ldb, 'Right Hand Side Matrix b')
    
    print *, "dgels Example Program Results"
    print *
    
    ! Workspace query
    lwork = -1
    call dgels(trans, m, n, nrhs, a, lda, b, ldb, work_query, lwork, info)
