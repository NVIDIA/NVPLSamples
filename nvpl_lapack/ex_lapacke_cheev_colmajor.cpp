...
int main()
{
    ...
    //     -6   -6   31    7
    //     -5   -5    7   23
    nvpl_scomplex_t A[lda * n] = {13, 3, -6, -5, 3, 13, -6, -5, -6, -6, 31, 7, -5, -5, 7, 23};
    ...
    printf("\n");
    printf("LAPACKE_cheev (col-major, high-level) Example Program Results\n");

    // Compute eigenvalue decomposition.
    char eigen_vectors = 'V';
    char lower = 'L';
    nvpl_int_t info = LAPACKE_cheev(LAPACK_COL_MAJOR, eigen_vectors, lower,
            n, A, lda, w);
