...
int main()
{
    ...
    //     -1   2   0   1
    //      3  -1   2   2
    double A[lda * n] = {1, 2, 2, -3, 0, 1, 2, 1, -1, 2, 0, 1, 3, -1, 2, 2};
    ...
    //     -1    3
    //      9   10
    double b[ldb * n] = {13, 1, 6, 7, -1, 3, 9, 10};
    ...
    // Solve A * x = b.
    nvpl_int_t info = LAPACKE_dgesv(LAPACK_ROW_MAJOR, n, nrhs, A, lda, ipiv,
            b, ldb);
    ...
    // Print LU factors.
    print_dmatrix_rowmajor("LU factors", n, n, A, lda);
    printf("\n");
