...
int main()
{
    ...
    //     -1   2   0   1
    //      3  -1   2   2
    nvpl_scomplex_t A[lda * n] = {1, 0, -1, 3, 2, 1, 2, -1, 2, 2, 0, 2, -3, 1, 1, 2};
    ...
    printf("\n");
    printf("LAPACKE_cgesv (col-major, high-level) Example Program Results\n");

    // Solve A * x = b.
    nvpl_int_t info = LAPACKE_cgesv(LAPACK_COL_MAJOR, n, nrhs, A, lda, ipiv,
            b, ldb);
