...
int main()
{
    ...
    //     -1   2   0   1
    //      3  -1   2   2
    float A[lda * n] = {1, 0, -1, 3, 2, 1, 2, -1, 2, 2, 0, 2, -3, 1, 1, 2};
    ...
    //     -1    3
    //      9   10
    float b[ldb * nrhs] = {13, 6, -1, 9, 1, 7, 3, 10};
    ...
    print_smatrix_colmajor("Right Hand Side b", n, nrhs, b, ldb);
    printf("\n");
    printf("LAPACKE_sgesv (col-major, high-level) Example Program Results\n");

    // Solve A * x = b.
    nvpl_int_t info = LAPACKE_sgesv(LAPACK_COL_MAJOR, n, nrhs, A, lda, ipiv,
            b, ldb);
    ...
    // Print LU factors.
    print_smatrix_colmajor("LU factors", n, n, A, lda);
    printf("\n");
