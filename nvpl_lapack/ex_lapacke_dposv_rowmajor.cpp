...
int main()
{
    ...
    //     -3    0   15   -8
    //      7   17   -8   23
    double A[lda * n] = {4, 5, -3, 7, 5, 16, 0, 17, -3, 0, 15, -8, 7, 17, -8, 23};
    ...
    print_dmatrix_rowmajor("Cholesky factor", n, n, A, lda);
    printf("\n");
