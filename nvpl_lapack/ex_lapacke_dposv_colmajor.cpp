...
int main()
{
    ...
    //      47   11
    //     -16   54
    double b[ldb * nrhs] = {-3, 9, 47, -16, 17, 55, 11, 54};
    ...
    printf("\n");
    printf("LAPACKE_dposv (col-major, high-level) Example Program Results\n");

    // Solve A * x = b using Cholesky decomposition.
    char lower = 'L';
    nvpl_int_t info = LAPACKE_dposv(LAPACK_COL_MAJOR, lower, n, nrhs, A, lda,
            b, ldb);
    ...
    print_dmatrix_colmajor("Cholesky factor", n, n, A, lda);
    printf("\n");
